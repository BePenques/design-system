...
var {
  ...
  createTheme,
  config
} = (0, import_react4.createStitches)({
  themeMap: __spreadProps(__spreadValues({}, import_react4.defaultThemeMap), {
    height: "space",
    // usar as configurações de space também para width/height
    width: "space"
  }),
  theme: {
    colors,
